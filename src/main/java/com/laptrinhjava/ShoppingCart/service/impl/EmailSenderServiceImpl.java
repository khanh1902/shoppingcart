...
public class EmailSenderServiceImpl implements IEmailSenderService {
    ...
    @Override
    public void constructResetTokenEmail(String contextPath, Locale locale, String token, Users user) throws MessagingException {
        String url = "https://minimogshop.vercel.app/reset-password?token=" + token;

        MimeMessage mimeMessage = mailSender.createMimeMessage();
        MimeMessageHelper helper = new MimeMessageHelper(mimeMessage, "utf-8");
        String body = renderHtml(url);
        mailSender.send(constructEmail("Reset Password", body, user));
    }
    ...
    private String renderHtml(String url){
        return "<!doctype html>\n" +
                ...
                "                          <a style=\"font-size:30px; font-weight:700;text-decoration: none; color:#000;\" href=\"https://minimogshop.vercel.app\" title=\"logo\" target=\"_blank\">\n" +
                "MinimogShop\n" +
                "                          </a>\n" +
                "                        </td>\n" +
                "                    </tr>\n" +
                ...
                "                    <tr>\n" +
                "                        <td style=\"text-align:center;\">\n" +
                "                            <p style=\"font-size:14px; color:rgba(69, 80, 86, 0.7411764705882353); line-height:18px; margin:0 0 0;\">&copy; <strong>minimogshop.vercel.app/</strong></p>\n" +
                "                        </td>\n" +
                "                    </tr>\n" +
                "                    <tr>\n" +
                "                        <td style=\"height:80px;\">&nbsp;</td>\n" +
