...
public interface IProductService {
    ...
    Page<Products> findWithFilterAndPageAndSort (Integer offset, Integer limit, String sortBy, String name);
    List<Map<String, String>> convertOptionsRequestToMap(OptionsRequest optionsRequest);
    List<Products> findByNameContainingIgnoreCase(String name);
    Page<Products> filterWithPaging(Integer offset, Integer limit, String sortBy, Boolean asc, String name, List<Long> categoryIds, Long minPrice, Long maxPrice);
